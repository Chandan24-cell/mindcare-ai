...
const THEME_STORAGE_KEY = 'mindcare-theme';

// Apply stored theme early to prevent flashes
...
function updateChart(latestData) {
    ...
    const { text: textColor, muted: mutedColor, grid: gridColor } = getThemeColors();
